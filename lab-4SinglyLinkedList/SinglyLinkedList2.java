...
//------------------------------------------------------------
    ...
    /*
التحقق من القائمه فارغه او عقده واحده موجوده يرجع null
تعين مؤشري القائمه الى راس النود
التقد حتى الوصول الى النود الاخيره في القاىمه
وبعدين نقوله ارجع لنا النود الثانيه قبل الاخيره
     */
     */
     *
